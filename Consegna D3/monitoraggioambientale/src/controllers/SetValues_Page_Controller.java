...
import static DAO.SetValuesDAO.updateValue;
...
public class SetValues_Page_Controller {
    ...
    void salvaMin_TempIsFired(ActionEvent event){
        try {
            ...
            information.setText("Il valore minimo accettabile per la Temperatura e ora di " + min_Temp.getText() + " gradi");
        } catch (Exception ex){
            ex.getStackTrace();
        }
    }
    ...
    void salvaMax_TempIsFired(ActionEvent event){
        try {
            ...
            information.setText("Il valore massimo accettabile per la Temperatura e ora di " + max_Temp.getText() + " gradi");
        } catch (Exception ex){
            ex.getStackTrace();
        }
    }
    ...
    void salvaMin_UmIsFired(ActionEvent event){
        try {
            ...
            information.setText("Il valore minimo accettabile per l'Umidita e ora del " + min_Um.getText() + " %");
        } catch (Exception ex){
            ex.getStackTrace();
        }
    }
    ...
    void salvaMax_UmIsFired(ActionEvent event){
        try {
            ...
            information.setText("Il valore massimo accettabile per l'Umidita e ora del " + max_Um.getText() + " %");
        } catch (Exception ex){
            ex.getStackTrace();
        }
    }
    ...
    void salvaMin_PresIsFired(ActionEvent event){
        try {
            ...
            information.setText("Il valore minimo accettabile per la Pressione e ora del " + min_Pres.getText() + " hPa");
        } catch (Exception ex){
            ex.getStackTrace();
        }
    }
    ...
    void salvaMax_PresIsFired(ActionEvent event){
        try {
            ...
            information.setText("Il valore massimo accettabile per la Pressione e ora di " + max_Pres.getText() + " hPa");
        } catch (Exception ex){
            ex.getStackTrace();
        }
    }
    ...
    void salvaMin_LumIsFired(ActionEvent event){
        try {
            ...
            information.setText("Il valore minimo accettabile per la Luminosita e ora di " + min_Lum.getText() + " lumen");
    ...
    void salvaMax_LumIsFired(ActionEvent event){
        try {
            ...
            information.setText("Il valore massimo accettabile per la Luminosita e ora di " + max_Lum.getText() + " lumen");
        } catch (Exception ex){
            ex.getStackTrace();
        }
    }
