...
import static DAO.BuildingDAO.*;
import static controllers.Login_Page_Controller.getUtente;

public class ShowDangers_Page_Controller {
    ...
    public class Aggiornamento extends Thread {
        ...
        public void run() {
            while (true) {
                try {
                    String color;
                    Map<String, Integer> pericoli = TestMostraMappa.mappaPericolo(Building_Page_Controller.getMappa());
                    int i = 0;
                    for (Map.Entry<String, Integer> entry : pericoli.entrySet()) {
