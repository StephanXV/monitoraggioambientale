...
import static DAO.BuildingDAO.creaListSensori;
import static DAO.BuildingDAO.average;
...
public class Building_Page_Controller {
    ...
    private static Map<String, Integer> mappa;

    public static Map<String,Integer> getMappa(){return mappa;}
    ...
    @FXML   //fx:id="alert_button"
    private Button showDangers;

    @FXML   //  fx:id="colStatus"
    private TableColumn<StanzaTabella, String> colNome; // Value injected by FXMLLoader

    @FXML   //  fx:id="colStatus"
    private TableColumn<StanzaTabella, Integer> colPiano; // Value injected by FXMLLoader

    @FXML   //  fx:id="colTemperatura"
    private TableColumn<StanzaTabella, Integer> colTemperatura; // Value injected by FXMLLoader

    @FXML   //  fx:id="colUmidità"
    private TableColumn<StanzaTabella, Integer> colUmidita; // Value injected by FXMLLoader
    ...
    private TableColumn<SensoreTabella, String> colCodice; // Value injected by FXMLLoader

    @FXML   //  fx:id="colTipo"
    private TableColumn<SensoreTabella, Integer> colTipo; // Value injected by FXMLLoader

    @FXML   //  fx:id="colValore"
    private TableColumn<SensoreTabella, Integer> colValore; // Value injected by FXMLLoader
    ...
    @FXML
    void showDangers_ButtonIsFired(ActionEvent event){
        try {
            FXMLLoader fxmlLoader = new FXMLLoader();
            fxmlLoader.setLocation(getClass().getResource("/layouts/ShowDangers_Page.fxml"));
    ...
    void alert_ButtonIsFired(ActionEvent event){
        try {
            ...
            Stage stage = new Stage();
            stage.setTitle("Allerta Autorita");
            stage.setScene(scene);
            stage.show();
        } catch (Exception e) {
                            ...
                            b.setOnAction(new EventHandler<ActionEvent>() {
                                ...
                                public void handle(ActionEvent e) {
                                    try{
                                        ...
                                        StanzaTabella st = average(creaListSensori(stanza.getRoom_name()), stanza.getRoom_name());
