...
import static DAO.MainDAO.registraValoriAssociati;
...
public class Valori {
	...
	public Valori(int id) throws SQLException {
		...
		this.min_hum = 30.0;
		this.max_hum = 70.0;
		registraValoriAssociati(this.id,this.min_temp, this.max_temp, this.min_lum, this.max_lum, this.min_pres, this.max_pres, this.min_hum, this.max_hum);
	}
